    ...
    SvtReader *r)
{
    ...
    if (pi->mi->skip_mode) {
        ref_frame[0] = (MvReferenceFrame)(dec_handle->frame_header.
            skip_mode_params.skip_mode_frame[0]);
        ref_frame[1] = (MvReferenceFrame)(dec_handle->frame_header.
            skip_mode_params.skip_mode_frame[1]);
    }
